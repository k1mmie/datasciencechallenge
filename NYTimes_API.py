...
api_key = '1e85cb4d72204fd381c03263555d7906'
...
for q in qs:
    ...
    for page in range(0, 10):
        r = requests.get('https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key={0}&q={1}&page={2}'.format(api_key, q, page))
        print(r.headers)
...
df.to_csv('C:/Users/Kim.Vuong/Documents/DataScienceChallenge/NYtimes2.csv')

df=pd.read_csv('C:/Users/Kim.Vuong/Documents/DataScienceChallenge/NYtimes.csv',encoding='latin')
